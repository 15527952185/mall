package com.myself.daily.controller;
...
import com.myself.daily.vo.req.BaseRequest;
import com.myself.daily.vo.resp.BaseResponse;
...
public class DemoController {
	...
	public BaseResponse demoPost(@Validated @RequestBody BaseRequest baseRequest) {
		...
		return new BaseResponse(baseRequest, CommonErrorCode.Forbidden);
	...
	public BaseResponse upload(@RequestParam("file") MultipartFile[] files,@PathVariable("id") String id,
		...
		return new BaseResponse(CommonErrorCode.SAVESUSSESS);
	}
}
